...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 6' do
    ...
    dishes_names = stores[:olive_garden][:dishes].collect{|dish| dish[:name]}
  ...
  it 'test 7' do
    ...
    # all restaurants
    employee_names = stores.collect{|key, store| store[:employees]}.flatten
  ...
  it 'test 8' do
    ...
    ingredients = stores.collect{|store, store_hash| store_hash[:dishes].collect{|dish| dish[:ingredients]}}.flatten
  ...
  it 'test 9' do
    ...
    full_menu_price = stores[:olive_garden][:dishes].collect{|dish| dish[:price]}.sum
  ...
  it 'test 10' do
    ...
    olive_garden_menu = stores[:olive_garden][:dishes].to_h{|dish| [dish[:name], dish]}
  ...
  it 'test 11' do
    ...
    full_menu = stores.collect{|store, store_hash| store_hash[:dishes]}.flatten.to_h{|dish| [dish[:name], dish]}
